            ...
            <Transition as={Fragment} show appear>
                <TransitionChild as={Fragment} enter={'transition-all duration-500'} enterFrom={'opacity-75 scale-150'} enterTo={'opacity-100 scale-100'}>
                    <div className={'relative h-screen w-screen'}>
                        ...
                        <div
                                className=" container-content absolute align-middle bottom-[40%] lg:top-[18%] mx-auto px-4 sm:px-6 lg:px-8 flex w-full items-center justify-center z-30">
                                <div>
                        ...
                        <TransitionChild as={Fragment} enter={'transition-all duration-500'} enterFrom={'opacity-75 scale-150'} enterTo={'opacity-100 scale-100'}>
                        <div className="container-content absolute align-middle bottom-[40%] lg:bottom-[12%] mx-auto px-4 sm:px-6 lg:px-8 flex w-full items-center justify-center z-30" >
                                    ...
                                    return (
                                        <div key={i} className={'col-span-1'}>
                                            <div className={'grid w-full items-center justify-center grid-rows-2'}>
                                                ...
                                                <div className={'row-span-1 text-white text-lg'}>{Item.text}</div>
                                            </div>
                                        </div>
                                    )
                                })}
