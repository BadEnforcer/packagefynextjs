            ...
            <>
                <main>
                    <div className="mx-auto max-w-7xl py-6 sm:px-6 lg:px-8">
                            ...
                            <div
                                ...
                                <div className="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-10">
                                    ...
                                    <div className="mt-5 max-w-3xl text-center mx-auto">
                                        <p className="text-lg text-gray-600 dark:text-neutral-400"> Find your best Holiday Package.</p>
                                    </div>
                        ...
                        {/*INTRO*/}
                        <section className="overflow-hidden pt-20 pb-12 lg:pt-[120px] lg:pb-[90px] bg-white dark:bg-[#1e232a] dark:text-white">
                        ...
                        <section>
                            ...
                            <div className="bg-white dark:bg-[#1e232a] ">
                                <div
