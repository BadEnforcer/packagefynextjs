            ...
            <Suspense fallback={<SpinnerFullScreen/>}>
                <section id={'Hero Section'} className={'relative overflow-hidden'}>
                    <Image src={backgroundImage} alt={'Background Image'} fill={true}
                           ...
                           fetchPriority={'high'} blurDataURL={backgroundBlurImage} loading={'eager'} quality={100} objectFit={'cover'}/>
                ...
                <section>
                    ...
                    <TripsWithPriceSlider heading1={'Best of'} heading2={"Indian"} heading3={"Heartland"} entries={content}/>
                    <TripsWithPriceSlider heading1={'Must visit'} heading2={'International'} heading3={"Destinations"} entries={files} rtl={false}/>
                </section>
